...
/* ═══════════════════════════════════════════════════════════════
        ...
        function createPatientCardChat(patient) {
            ...
            // PHOTOFIT V5.2 : Score badge déplacé inline avant PATHOLOGIES (voir section patho)
            ...
            // ║ PHOTOFIT V5.2 : Score de similarité INLINE avant PATHOLOGIES
            // ╚═══════════════════════════════════════════════════════════════
            ...
            if (pathoSource) {
                ...
                // PHOTOFIT V5.2 : Header flex avec score + titre PATHOLOGIES
                ...
                if (patient.similarity_score !== undefined && patient.similarity_score !== null) {
                    ...
                    scoreBadge.title = score === 100 
                        ...
                        : `Similarité : ${score}%`;
                    pathoHeader.appendChild(scoreBadge);
                }
                
                const pathoTitle = document.createElement('div');
                pathoTitle.className = 'patient-card-section-title';
                pathoTitle.style.margin = '0';
                pathoTitle.textContent = t('PATHOLOGIES');
                pathoHeader.appendChild(pathoTitle);
